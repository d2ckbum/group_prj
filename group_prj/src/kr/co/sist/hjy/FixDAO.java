...
public class FixDAO {
 ...
 // ============= OrderService INSERT 메소드 끝 =============
	...
	public List<FixPanelVO> selectAllList() throws SQLException{
		...
		.append("	mf.mfg_name,   c.CAR_TYPE,   f.mem_num,   m.MEM_NAME,		")
		.append(" f.total_price,   f.fix_status, f.fix_memo, m.mem_tell 		")
		.append("	from	fix f, car c, member m, manufacturer mf		")
		.append("	where f.mem_num=m.mem_num and m.car_num=c.car_num  and m.mfg_num=mf.mfg_num		")
